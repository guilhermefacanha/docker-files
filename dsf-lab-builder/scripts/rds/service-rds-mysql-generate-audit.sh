...
MYSQL="mysql --protocol=tcp --ssl-mode=DISABLED -h $RDS_ADDRESS -P $RDS_PORT -u $DB_MASTER_USER -p${DB_MASTER_PASS} $DB_NAME --connect-timeout=10"
...
cat <<EOF
  ...
  appear in CloudWatch log group:
